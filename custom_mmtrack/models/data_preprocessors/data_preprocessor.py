...
class TrackDataPreprocessor_MultiRefImgs(BaseDataPreprocessor):
    ...
    def forward(self, data: dict, training: bool = False) -> Dict:
        ...
        for imgs_key, imgs in ori_inputs.items():
            ...
            if self._enable_normalize and channel == 3:
        ...
        if data_samples is not None:
            ...
            for key, imgs in inputs.items():
                ...
                if key[-3:] == 'img' and self.pad_mask and ref_prefix != 'reff_' and ref_prefix != 'refff_':
