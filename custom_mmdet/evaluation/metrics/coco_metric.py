...
class CocoMetric_CovertVideo2Image(BaseMetric):
    ...
    def __init__(self,
                 ...
                 is_video_dataset: bool = False) -> None:
    ...
    def convert_data_samples_video2image(self, data_samples: Sequence[dict]):
        for i in range(len(data_samples)):
            data_samples[i]['pred_instances'] = data_samples[i]['pred_track_instances']
    ...
    def process(self, data_batch: dict, data_samples: Sequence[dict]) -> None:
        ...
        for data_sample in data_samples:
            ...
            if self.is_video_dataset:
                self.convert_data_samples_video2image(data_samples)
    ...
    def converte_meta_data_video2image(self):
        if 'classes' not in self.dataset_meta.keys():
            self.dataset_meta['classes'] = self.dataset_meta['CLASSES']
        self._coco_api.dataset['info'] = dict()
    ...
    def compute_metrics(self, results: list) -> Dict[str, float]:
        ...
        if self.is_video_dataset:
            self.converte_meta_data_video2image()
        ...
        for metric in self.metrics:
            ...
            if metric == 'proposal':
                ...
                logger.info(f"{metric.upper()} IMAGE evaluation results:")
                coco_eval.summarize()
